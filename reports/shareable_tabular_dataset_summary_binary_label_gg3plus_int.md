...
- Rows after common filters (label_join_status == 'coord_match', `binary_label_gg3plus_int` not null, split in ('train', 'val', 'test')): 16,992
...
| Split | Rows | Patients | `binary_label_gg3plus_int` prevalence |
|---|---|---|---|
| train | 11,827 | 557 | 0.040 |
| val | 2,748 | 119 | 0.029 |
| test | 2,417 | 120 | 0.038 |
